...
import { BRAND_ICON_DATA_URI } from "./brand-icon"
...
// Brand icon — circular bitmap derived from packages/desktop/icons/prod/round.png
// (mirrors packages/ui/src/components/logo.tsx). Replaces the old OpenCode wordmark SVG.
const WORDMARK = `<img class="wordmark" src="${BRAND_ICON_DATA_URI}" alt="NekoCode" width="160" height="160" role="img" />`
