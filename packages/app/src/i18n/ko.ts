export const dict = {
  ...
  "dialog.addModel.title": "모델 추가",
  "dialog.addModel.placeholder": "모델을 구성할 공급자 선택",
  "dialog.addModel.provider.label": "공급자",
  "dialog.addModel.provider.placeholder": "공급자 선택",
  "dialog.addModel.provider.connected": "연결됨",
  "dialog.addModel.provider.group.available": "사용 가능한 공급자",
  "dialog.addModel.connected.description": "이 공급자는 이미 연결되어 있습니다. 모델 선택기에 표시할 모델을 전환하세요.",
  "dialog.addModel.custom.append.description": "이 사용자 지정 공급자에 새 모델을 추가합니다. 기존 구성은 유지됩니다.",
  "dialog.addModel.custom.append.success.title": "모델 추가됨",
  "dialog.addModel.custom.append.success.description": "{{provider}}에 모델 추가됨",

  "dialog.model.unpaid.freeModels.title": "NekoCode에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 NekoCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 NekoCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 NekoCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 NekoCode 서버를 전환합니다.",
  ...
  "toast.update.description": "NekoCode의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 NekoCode 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: NekoCode는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.tab.pet": "데스크톱 펫",
  "settings.pet.row.enabled.title": "데스크톱 펫 표시",
  "settings.pet.row.enabled.description": "바탕 화면에 항상 위에 표시되는 창으로 펫을 표시합니다",
  "settings.pet.row.character.title": "캐릭터",
  "settings.pet.row.character.description": "표시할 펫 캐릭터를 선택하세요",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 통합",
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 NekoCode 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "NekoCode 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 NekoCode가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "NekoCode가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "NekoCode 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "NekoCode를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 NekoCode를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "NekoCode 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 NekoCode 확인 중...",
  "wsl.onboarding.updatingOpencode": "NekoCode 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 NekoCode 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 NekoCode를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "NekoCode 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 NekoCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "NekoCode가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 NekoCode를 설치하세요.",
  "wsl.onboarding.installOpencode": "NekoCode 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NekoCode에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "NekoCode에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 NekoCode를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 NekoCode Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "NekoCode를 불러오지 못했습니다",
  "desktop.recovery.terminated": "NekoCode 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "NekoCode가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "NekoCode 설치 실패",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 NekoCode가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "NekoCode 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
