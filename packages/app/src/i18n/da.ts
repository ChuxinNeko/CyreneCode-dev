export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i CyreneCode.",
  ...
  "dialog.server.description": "Skift hvilken CyreneCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker CyreneCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer CyreneCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater CyreneCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før CyreneCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter CyreneCode igen.",
  ...
  "toast.update.description": "En ny version af CyreneCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CyreneCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CyreneCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CyreneCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CyreneCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan CyreneCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om CyreneCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas CyreneCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CyreneCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CyreneCode.",
  ...
  "desktop.recovery.loadFailed": "CyreneCode kunne ikke indlæses",
  "desktop.recovery.terminated": "CyreneCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af CyreneCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af CyreneCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "CyreneCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
