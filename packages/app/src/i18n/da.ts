export const dict = {
  ...
  "dialog.addModel.title": "Tilføj model",
  "dialog.addModel.placeholder": "Vælg en udbyder for at konfigurere modeller",
  "dialog.addModel.provider.label": "Udbyder",
  "dialog.addModel.provider.placeholder": "Vælg en udbyder",
  "dialog.addModel.provider.connected": "Forbundet",
  "dialog.addModel.provider.group.available": "Tilgængelige udbydere",
  "dialog.addModel.connected.description": "Denne udbyder er allerede forbundet. Skift hvilke modeller der vises i modelvælgeren.",
  "dialog.addModel.custom.append.description": "Tilføj nye modeller til denne tilpassede udbyder. Eksisterende konfiguration bevares.",
  "dialog.addModel.custom.append.success.title": "Modeller tilføjet",
  "dialog.addModel.custom.append.success.description": "Tilføjede modeller til {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i NekoCode.",
  ...
  "dialog.server.description": "Skift hvilken NekoCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker NekoCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer NekoCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater NekoCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før NekoCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "NekoCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter NekoCode igen.",
  ...
  "toast.update.description": "En ny version af NekoCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NekoCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NekoCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.tab.pet": "Skrivebordskæledyr",
  "settings.pet.row.enabled.title": "Vis skrivebordskæledyr",
  "settings.pet.row.enabled.description": "Viser et kæledyr i et vindue, der altid er øverst på dit skrivebord",
  "settings.pet.row.character.title": "Karakter",
  "settings.pet.row.character.description": "Vælg hvilket kæledyr der skal vises",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-integration",
  "settings.desktop.wsl.description": "Kør NekoCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NekoCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan NekoCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om NekoCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas NekoCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NekoCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NekoCode.",
  ...
  "desktop.recovery.loadFailed": "NekoCode kunne ikke indlæses",
  "desktop.recovery.terminated": "NekoCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af NekoCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af NekoCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "NekoCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
