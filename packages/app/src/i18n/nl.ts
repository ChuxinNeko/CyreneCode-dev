export const dict = {
  ...
  "desktop.menu.documentation": "NekoCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "NekoCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het NekoCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "NekoCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van NekoCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De NekoCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.addModel.title": "Model toevoegen",
  "dialog.addModel.placeholder": "Selecteer een aanbieder om modellen te configureren",
  "dialog.addModel.provider.label": "Aanbieder",
  "dialog.addModel.provider.placeholder": "Selecteer een aanbieder",
  "dialog.addModel.provider.connected": "Verbonden",
  "dialog.addModel.provider.group.available": "Beschikbare aanbieders",
  "dialog.addModel.connected.description": "Deze aanbieder is al verbonden. Schakel welke modellen in de modelkiezer verschijnen.",
  "dialog.addModel.custom.append.description": "Voeg nieuwe modellen toe aan deze aangepaste aanbieder. De bestaande configuratie wordt behouden.",
  "dialog.addModel.custom.append.success.title": "Modellen toegevoegd",
  "dialog.addModel.custom.append.success.description": "Modellen toegevoegd aan {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in NekoCode te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in NekoCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in NekoCode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke NekoCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "NekoCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "NekoCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "NekoCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "NekoCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk NekoCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "NekoCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "NekoCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer NekoCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat NekoCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "NekoCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens NekoCode opnieuw.",
  ...
  "help.tabs.introduction": "NekoCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van NekoCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het NekoCode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: NekoCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.tab.pet": "Bureaubladhuisdier",
  "settings.pet.row.enabled.title": "Bureaubladhuisdier tonen",
  "settings.pet.row.enabled.description": "Toont een huisdiergezel in een venster dat altijd bovenaan op je bureaublad staat",
  "settings.pet.row.character.title": "Personage",
  "settings.pet.row.character.description": "Kies welk huisdier je wilt tonen",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-integratie",
  "settings.desktop.wsl.description": "Voer de NekoCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor NekoCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe NekoCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of NekoCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van NekoCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer NekoCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "NekoCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van NekoCode.",
