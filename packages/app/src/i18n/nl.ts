export const dict = {
  ...
  "desktop.menu.documentation": "CyreneCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "CyreneCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het CyreneCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "CyreneCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van CyreneCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De CyreneCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in CyreneCode te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in CyreneCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in CyreneCode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke CyreneCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "CyreneCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "CyreneCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "CyreneCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "CyreneCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk CyreneCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "CyreneCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer CyreneCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat CyreneCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens CyreneCode opnieuw.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van CyreneCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het CyreneCode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: CyreneCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de CyreneCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor CyreneCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe CyreneCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of CyreneCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van CyreneCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer CyreneCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "CyreneCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van CyreneCode.",
