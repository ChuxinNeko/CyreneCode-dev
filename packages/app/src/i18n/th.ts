export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด NekoCode ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง NekoCode หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "NekoCode ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง NekoCode ล้มเหลว",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง NekoCode ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต NekoCode เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.addModel.title": "เพิ่มโมเดล",
  "dialog.addModel.placeholder": "เลือกผู้ให้บริการเพื่อกำหนดค่าโมเดล",
  "dialog.addModel.provider.label": "ผู้ให้บริการ",
  "dialog.addModel.provider.placeholder": "เลือกผู้ให้บริการ",
  "dialog.addModel.provider.connected": "เชื่อมต่อแล้ว",
  "dialog.addModel.provider.group.available": "ผู้ให้บริการที่พร้อมใช้งาน",
  "dialog.addModel.connected.description": "ผู้ให้บริการนี้เชื่อมต่อแล้ว สลับโมเดลที่จะปรากฏในตัวเลือกโมเดล",
  "dialog.addModel.custom.append.description": "เพิ่มโมเดลใหม่ไปยังผู้ให้บริการแบบกำหนดเองนี้ คงค่าการกำหนดค่าที่มีอยู่ไว้",
  "dialog.addModel.custom.append.success.title": "เพิ่มโมเดลแล้ว",
  "dialog.addModel.custom.append.success.description": "เพิ่มโมเดลไปยัง {{provider}}",

  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย NekoCode",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน NekoCode",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน NekoCode",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน NekoCode",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ NekoCode ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ NekoCode ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต NekoCode ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต NekoCode ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "NekoCode พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง NekoCode ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง NekoCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ NekoCode จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "NekoCode ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด NekoCode อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ NekoCode Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ NekoCode ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม NekoCode",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า NekoCode ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "NekoCode รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.tab.pet": "สัตว์เลี้ยงเดสก์ท็อป",
  "settings.pet.row.enabled.title": "แสดงสัตว์เลี้ยงเดสก์ท็อป",
  "settings.pet.row.enabled.description": "แสดงสัตว์เลี้ยงคู่ใจในหน้าต่างที่อยู่ด้านบนสุดบนเดสก์ท็อปของคุณ",
  "settings.pet.row.character.title": "ตัวละคร",
  "settings.pet.row.character.description": "เลือกตัวละครสัตว์เลี้ยงที่ต้องการแสดง",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "การรวม WSL",
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ NekoCode ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ NekoCode",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ NekoCode บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ NekoCode ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ NekoCode",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ NekoCode เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน NekoCode เวอร์ชันล่าสุด",
