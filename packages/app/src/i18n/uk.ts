export const dict = {
  ...
  "desktop.menu.documentation": "Документація NekoCode",
  ...
  "desktop.menu.ariaLabel": "Меню NekoCode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити NekoCode",
  "desktop.recovery.terminated": "Роботу вікна NekoCode несподівано завершено",
  "desktop.recovery.unresponsive": "NekoCode не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити NekoCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення NekoCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.addModel.title": "Додати модель",
  "dialog.addModel.placeholder": "Виберіть провайдера для налаштування моделей",
  "dialog.addModel.provider.label": "Провайдер",
  "dialog.addModel.provider.placeholder": "Виберіть провайдера",
  "dialog.addModel.provider.connected": "Підключено",
  "dialog.addModel.provider.group.available": "Доступні провайдери",
  "dialog.addModel.connected.description": "Цей провайдер уже підключено. Перемкніть, які моделі відображатимуться у виборі моделей.",
  "dialog.addModel.custom.append.description": "Додайте нові моделі до цього користувацького провайдера. Налаштування зберігаються.",
  "dialog.addModel.custom.append.success.title": "Моделі додано",
  "dialog.addModel.custom.append.success.description": "Додано моделі до {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у NekoCode.",
  ...
  "dialog.server.description": "Перемкніть сервер NekoCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка NekoCode у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення NekoCode у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть NekoCode у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть NekoCode у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в NekoCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "NekoCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія NekoCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді NekoCode",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, NekoCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.tab.pet": "Настільний улюбленець",
  "settings.pet.row.enabled.title": "Показувати настільного улюбленця",
  "settings.pet.row.enabled.description": "Відображає улюбленця-компаньйона у вікні поверх усіх вікон на робочому столі",
  "settings.pet.row.character.title": "Персонаж",
  "settings.pet.row.character.description": "Оберіть, якого улюбленця показувати",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Інтеграція WSL",
  "settings.desktop.wsl.description": "Запускати сервер NekoCode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу NekoCode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд NekoCode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи NekoCode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему NekoCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску NekoCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію NekoCode.",
