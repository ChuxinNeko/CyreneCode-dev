export const dict = {
  ...
  "desktop.menu.documentation": "NekoCode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "NekoCode مینو",
  ...
  "desktop.recovery.loadFailed": "NekoCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "NekoCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "NekoCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "NekoCode کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں NekoCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "NekoCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.addModel.title": "ماڈل شامل کریں",
  "dialog.addModel.placeholder": "ماڈل کنفیگر کرنے کے لیے فراہم کنندہ منتخب کریں",
  "dialog.addModel.provider.label": "فراہم کنندہ",
  "dialog.addModel.provider.placeholder": "فراہم کنندہ منتخب کریں",
  "dialog.addModel.provider.connected": "منسلک",
  "dialog.addModel.provider.group.available": "دستیاب فراہم کنندگان",
  "dialog.addModel.connected.description": "یہ فراہم کنندہ پہلے ہی منسلک ہے۔ ٹوگل کریں کہ ماڈل سلیکٹر میں کون سے ماڈل نظر آئیں۔",
  "dialog.addModel.custom.append.description": "اس کسٹم فراہم کنندہ میں نئے ماڈلز شامل کریں۔ موجودہ کنفیگریشن محفوظ رہے گی۔",
  "dialog.addModel.custom.append.success.title": "ماڈلز شامل کر دیے گئے",
  "dialog.addModel.custom.append.success.description": "{{provider}} میں ماڈلز شامل کیے گئے",

  "dialog.model.unpaid.freeModels.title": "NekoCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور NekoCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور NekoCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور NekoCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس NekoCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "NekoCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں NekoCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "NekoCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں NekoCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں NekoCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "NekoCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "NekoCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "NekoCode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں NekoCode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "NekoCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ NekoCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "NekoCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر NekoCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "NekoCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NekoCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم NekoCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، NekoCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "NekoCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "NekoCode ڈیسک ٹاپ",
  "settings.section.desktop": "ڈیسک ٹاپ",
  "settings.section.server": "سرور",
  "settings.tab.general": "عمومی",
  "settings.tab.shortcuts": "شارٹ کٹس",
  "settings.tab.pet": "ڈیسک ٹاپ پالتو",
  "settings.pet.row.enabled.title": "ڈیسک ٹاپ پالتو دکھائیں",
  "settings.pet.row.enabled.description": "آپ کے ڈیسک ٹاپ پر ہمیشہ سب سے اوپر رہنے والی ونڈو میں ایک پالتو ساتھی دکھاتا ہے",
  "settings.pet.row.character.title": "کردار",
  "settings.pet.row.character.description": "منتخب کریں کہ کون سا پالتو کردار دکھانا ہے",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL انضمام",
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر NekoCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "NekoCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر NekoCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا NekoCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "NekoCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "NekoCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ NekoCode کا تازہ ترین ورژن چلا رہے ہیں۔",
