export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu NekoCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được NekoCode",
  "desktop.recovery.terminated": "Cửa sổ NekoCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "NekoCode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được NekoCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật NekoCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.addModel.title": "Thêm mô hình",
  "dialog.addModel.placeholder": "Chọn nhà cung cấp để cấu hình mô hình",
  "dialog.addModel.provider.label": "Nhà cung cấp",
  "dialog.addModel.provider.placeholder": "Chọn nhà cung cấp",
  "dialog.addModel.provider.connected": "Đã kết nối",
  "dialog.addModel.provider.group.available": "Nhà cung cấp khả dụng",
  "dialog.addModel.connected.description": "Nhà cung cấp này đã được kết nối. Bật/tắt mô hình nào xuất hiện trong bộ chọn mô hình.",
  "dialog.addModel.custom.append.description": "Thêm các mô hình mới vào nhà cung cấp tùy chỉnh này. Cấu hình hiện có được giữ nguyên.",
  "dialog.addModel.custom.append.success.title": "Đã thêm mô hình",
  "dialog.addModel.custom.append.success.description": "Đã thêm mô hình vào {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do NekoCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong NekoCode.",
  ...
  "dialog.server.description": "Chuyển máy chủ NekoCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra NekoCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật NekoCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật NekoCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt NekoCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi NekoCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "NekoCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của NekoCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm NekoCode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: NekoCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.tab.pet": "Thú cưng màn hình",
  "settings.pet.row.enabled.title": "Hiển thị thú cưng màn hình",
  "settings.pet.row.enabled.description": "Hiển thị một thú cưng đồng hành trong cửa sổ luôn nổi trên màn hình của bạn",
  "settings.pet.row.character.title": "Nhân vật",
  "settings.pet.row.character.description": "Chọn nhân vật thú cưng để hiển thị",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL tích hợp",
  "settings.desktop.wsl.description": "Chạy máy chủ NekoCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho NekoCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của NekoCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem NekoCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của NekoCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi NekoCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của NekoCode.",
