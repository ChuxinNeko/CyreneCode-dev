export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu CyreneCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được CyreneCode",
  "desktop.recovery.terminated": "Cửa sổ CyreneCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "CyreneCode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được CyreneCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật CyreneCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do CyreneCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong CyreneCode.",
  ...
  "dialog.server.description": "Chuyển máy chủ CyreneCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra CyreneCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật CyreneCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật CyreneCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt CyreneCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi CyreneCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại CyreneCode.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của CyreneCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm CyreneCode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: CyreneCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ CyreneCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho CyreneCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của CyreneCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem CyreneCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của CyreneCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi CyreneCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của CyreneCode.",
