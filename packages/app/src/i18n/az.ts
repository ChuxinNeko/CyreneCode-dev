export const dict = {
  ...
  "desktop.recovery.loadFailed": "NekoCode yüklənə bilmədi",
  "desktop.recovery.terminated": "NekoCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "NekoCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "NekoCode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "NekoCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.addModel.title": "Model əlavə et",
  "dialog.addModel.placeholder": "Modelləri konfiqurasiya etmək üçün provayder seçin",
  "dialog.addModel.provider.label": "Provayder",
  "dialog.addModel.provider.placeholder": "Provayder seçin",
  "dialog.addModel.provider.connected": "Qoşuldu",
  "dialog.addModel.provider.group.available": "Mövcud provayderlər",
  "dialog.addModel.connected.description": "Bu provayder artıq qoşuludur. Model seçicisində hansı modellərin görünəcəyini açın/bağlayın.",
  "dialog.addModel.custom.append.description": "Bu xüsusi provayderə yeni modellər əlavə edin. Mövcud konfiqurasiya qorunur.",
  "dialog.addModel.custom.append.success.title": "Modellər əlavə edildi",
  "dialog.addModel.custom.append.success.description": "{{provider}} üçün modellər əlavə edildi",

  "dialog.model.unpaid.freeModels.title": "NekoCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və NekoCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və NekoCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və NekoCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu NekoCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "NekoCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də NekoCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "NekoCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də NekoCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də NekoCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "NekoCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "NekoCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "NekoCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "NekoCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "NekoCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NekoCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "NekoCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra NekoCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "NekoCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NekoCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı NekoCode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: NekoCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.tab.pet": "Masaüstü ev heyvanı",
  "settings.pet.row.enabled.title": "Masaüstü ev heyvanını göstər",
  "settings.pet.row.enabled.description": "Masaüstünüzdə həmişə üstdə olan pəncərədə ev heyvanı göstərir",
  "settings.pet.row.character.title": "Personaj",
  "settings.pet.row.character.description": "Hansı ev heyvanı personajının göstəriləcəyini seçin",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL inteqrasiyası",
  "settings.desktop.wsl.description": "Windows-da WSL daxilində NekoCode serverini işlət.",
  ...
  "settings.general.row.language.description": "NekoCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "NekoCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "NekoCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "NekoCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "NekoCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "NekoCode-un ən son versiyasından istifadə edirsiniz.",
