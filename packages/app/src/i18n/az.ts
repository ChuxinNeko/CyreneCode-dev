export const dict = {
  ...
  "desktop.recovery.loadFailed": "CyreneCode yüklənə bilmədi",
  "desktop.recovery.terminated": "CyreneCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "CyreneCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "CyreneCode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "CyreneCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CyreneCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və CyreneCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və CyreneCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və CyreneCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu CyreneCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "CyreneCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də CyreneCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "CyreneCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də CyreneCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də CyreneCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "CyreneCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "CyreneCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "CyreneCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "CyreneCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CyreneCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra CyreneCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CyreneCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı CyreneCode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: CyreneCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində CyreneCode serverini işlət.",
  ...
  "settings.general.row.language.description": "CyreneCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "CyreneCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "CyreneCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "CyreneCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "CyreneCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "CyreneCode-un ən son versiyasından istifadə edirsiniz.",
