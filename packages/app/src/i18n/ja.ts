export const dict = {
  ...
  "desktop.recovery.loadFailed": "NekoCodeを読み込めませんでした",
  "desktop.recovery.terminated": "NekoCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "NekoCodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "NekoCodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはNekoCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "NekoCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.addModel.title": "モデルを追加",
  "dialog.addModel.placeholder": "モデルを設定するプロバイダーを選択",
  "dialog.addModel.provider.label": "プロバイダー",
  "dialog.addModel.provider.placeholder": "プロバイダーを選択",
  "dialog.addModel.provider.connected": "接続済み",
  "dialog.addModel.provider.group.available": "利用可能なプロバイダー",
  "dialog.addModel.connected.description": "このプロバイダーは既に接続されています。モデルセレクターに表示するモデルを切り替えます。",
  "dialog.addModel.custom.append.description": "このカスタムプロバイダーに新しいモデルを追加します。既存の設定は保持されます。",
  "dialog.addModel.custom.append.success.title": "モデルを追加しました",
  "dialog.addModel.custom.append.success.description": "{{provider}} にモデルを追加しました",

  "dialog.model.unpaid.freeModels.title": "NekoCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、NekoCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNekoCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、NekoCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するNekoCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "NekoCodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のNekoCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "NekoCodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のNekoCodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のNekoCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "NekoCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のNekoCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "NekoCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にNekoCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "NekoCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NekoCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、NekoCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "NekoCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NekoCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNekoCodeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NekoCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "NekoCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.tab.pet": "デスクトップペット",
  "settings.pet.row.enabled.title": "デスクトップペットを表示",
  "settings.pet.row.enabled.description": "デスクトップ上に常時最前面のウィンドウでペットを表示します",
  "settings.pet.row.character.title": "キャラクター",
  "settings.pet.row.character.description": "表示するペットキャラクターを選択",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL連携",
  "settings.desktop.wsl.description": "WindowsのWSL環境でNekoCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "NekoCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNekoCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "NekoCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "NekoCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "NekoCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "NekoCode は最新バージョンです。",
