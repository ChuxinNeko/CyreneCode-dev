export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل CyreneCode",
  "desktop.recovery.terminated": "توقفت نافذة CyreneCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "CyreneCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت CyreneCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث CyreneCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك CyreneCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في CyreneCode.",
  ...
  "dialog.server.description": "تبديل خادم CyreneCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من CyreneCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث CyreneCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث CyreneCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت CyreneCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن CyreneCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على CyreneCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح CyreneCode.",
  ...
  "help.tabs.introduction": "أصبح CyreneCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من CyreneCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق CyreneCode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن CyreneCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن CyreneCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم CyreneCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ CyreneCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور CyreneCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان CyreneCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة CyreneCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل CyreneCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من CyreneCode.",
