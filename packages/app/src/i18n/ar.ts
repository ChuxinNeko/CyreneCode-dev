export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل NekoCode",
  "desktop.recovery.terminated": "توقفت نافذة NekoCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "NekoCode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت NekoCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث NekoCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.addModel.title": "إضافة نموذج",
  "dialog.addModel.placeholder": "اختر موفرًا لتكوين النماذج",
  "dialog.addModel.provider.label": "الموفر",
  "dialog.addModel.provider.placeholder": "اختر موفرًا",
  "dialog.addModel.provider.connected": "متصل",
  "dialog.addModel.provider.group.available": "الموفرون المتاحون",
  "dialog.addModel.connected.description": "هذا الموفر متصل بالفعل. بدّل النماذج التي تظهر في محدد النماذج.",
  "dialog.addModel.custom.append.description": "أضف نماذج جديدة إلى هذا الموفر المخصص. يتم الحفاظ على التكوين الحالي.",
  "dialog.addModel.custom.append.success.title": "تمت إضافة النماذج",
  "dialog.addModel.custom.append.success.description": "تمت إضافة نماذج إلى {{provider}}",

  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من NekoCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك NekoCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في NekoCode.",
  ...
  "dialog.server.description": "تبديل خادم NekoCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من NekoCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث NekoCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث NekoCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت NekoCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن NekoCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على NekoCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح NekoCode.",
  ...
  "help.tabs.introduction": "أصبح NekoCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من NekoCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق NekoCode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن NekoCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن NekoCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.tab.pet": "حيوان سطح المكتب",
  "settings.pet.row.enabled.title": "إظهار حيوان سطح المكتب",
  "settings.pet.row.enabled.description": "يعرض حيوانًا أليفًا مرافقًا في نافذة دائمة الظهور على سطح المكتب",
  "settings.pet.row.character.title": "الشخصية",
  "settings.pet.row.character.description": "اختر شخصية الحيوان التي تريد عرضها",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "تكامل WSL",
  "settings.desktop.wsl.description": "تشغيل خادم NekoCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ NekoCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور NekoCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان NekoCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة NekoCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل NekoCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من NekoCode.",
