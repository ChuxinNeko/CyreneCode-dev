export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do NekoCode",
  ...
  "desktop.menu.ariaLabel": "Menu do NekoCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o NekoCode",
  "desktop.recovery.terminated": "A janela do NekoCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O NekoCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do NekoCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O NekoCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do NekoCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.addModel.title": "Adicionar modelo",
  "dialog.addModel.placeholder": "Selecione um provedor para configurar modelos",
  "dialog.addModel.provider.label": "Provedor",
  "dialog.addModel.provider.placeholder": "Selecione um provedor",
  "dialog.addModel.provider.connected": "Conectado",
  "dialog.addModel.provider.group.available": "Provedores disponíveis",
  "dialog.addModel.connected.description": "Este provedor já está conectado. Alterne quais modelos aparecem no seletor de modelos.",
  "dialog.addModel.custom.append.description": "Adicione novos modelos a este provedor personalizado. A configuração existente é preservada.",
  "dialog.addModel.custom.append.success.title": "Modelos adicionados",
  "dialog.addModel.custom.append.success.description": "Modelos adicionados a {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no NekoCode.",
  ...
  "dialog.server.description": "Trocar para qual servidor NekoCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o NekoCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o NekoCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o NekoCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o NekoCode",
  "wsl.onboarding.opencodeReadyIn": "O NekoCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O NekoCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o NekoCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o NekoCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O NekoCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o NekoCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o NekoCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do NekoCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do NekoCode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: NekoCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.tab.pet": "Pet da área de trabalho",
  "settings.pet.row.enabled.title": "Mostrar pet da área de trabalho",
  "settings.pet.row.enabled.description": "Exibe um pet companheiro em uma janela sempre visível na sua área de trabalho",
  "settings.pet.row.character.title": "Personagem",
  "settings.pet.row.character.description": "Escolha qual personagem mostrar",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integração com WSL",
  "settings.desktop.wsl.description": "Executar o servidor NekoCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do NekoCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o NekoCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o NekoCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o NekoCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o NekoCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do NekoCode.",
