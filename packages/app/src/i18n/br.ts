export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do CyreneCode",
  ...
  "desktop.menu.ariaLabel": "Menu do CyreneCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o CyreneCode",
  "desktop.recovery.terminated": "A janela do CyreneCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O CyreneCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do CyreneCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O CyreneCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do CyreneCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CyreneCode.",
  ...
  "dialog.server.description": "Trocar para qual servidor CyreneCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o CyreneCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o CyreneCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o CyreneCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "O CyreneCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O CyreneCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o CyreneCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o CyreneCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O CyreneCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o CyreneCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o CyreneCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do CyreneCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CyreneCode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CyreneCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CyreneCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CyreneCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o CyreneCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CyreneCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CyreneCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CyreneCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CyreneCode.",
