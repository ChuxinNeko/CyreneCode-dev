export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'CyreneCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'CyreneCode",
  "desktop.recovery.terminated": "La fenêtre CyreneCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "CyreneCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'CyreneCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'CyreneCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CyreneCode.",
  ...
  "dialog.server.description": "Changez le serveur CyreneCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'CyreneCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'CyreneCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour CyreneCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez CyreneCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'CyreneCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez CyreneCode.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'CyreneCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe CyreneCode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CyreneCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "CyreneCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CyreneCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour CyreneCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'CyreneCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si CyreneCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'CyreneCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CyreneCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CyreneCode.",
