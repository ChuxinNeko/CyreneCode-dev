export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'NekoCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'NekoCode",
  "desktop.recovery.terminated": "La fenêtre NekoCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "NekoCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'NekoCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'NekoCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.addModel.title": "Ajouter un modèle",
  "dialog.addModel.placeholder": "Sélectionner un fournisseur pour configurer les modèles",
  "dialog.addModel.provider.label": "Fournisseur",
  "dialog.addModel.provider.placeholder": "Sélectionner un fournisseur",
  "dialog.addModel.provider.connected": "Connecté",
  "dialog.addModel.provider.group.available": "Fournisseurs disponibles",
  "dialog.addModel.connected.description": "Ce fournisseur est déjà connecté. Activez ou désactivez les modèles qui apparaissent dans le sélecteur.",
  "dialog.addModel.custom.append.description": "Ajoutez de nouveaux modèles à ce fournisseur personnalisé. La configuration existante est conservée.",
  "dialog.addModel.custom.append.success.title": "Modèles ajoutés",
  "dialog.addModel.custom.append.success.description": "Modèles ajoutés à {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NekoCode.",
  ...
  "dialog.server.description": "Changez le serveur NekoCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'NekoCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'NekoCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour NekoCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez NekoCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'NekoCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "NekoCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'NekoCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe NekoCode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'NekoCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "NekoCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.tab.pet": "Animal de bureau",
  "settings.pet.row.enabled.title": "Afficher l'animal de bureau",
  "settings.pet.row.enabled.description": "Affiche un compagnon dans une fenêtre toujours au premier plan sur votre bureau",
  "settings.pet.row.character.title": "Personnage",
  "settings.pet.row.character.description": "Choisissez quel animal afficher",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Intégration WSL",
  "settings.desktop.wsl.description": "Exécuter le serveur NekoCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour NekoCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NekoCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NekoCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'NekoCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NekoCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NekoCode.",
