export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de CyreneCode",
  ...
  "desktop.menu.ariaLabel": "Menú de CyreneCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar CyreneCode",
  "desktop.recovery.terminated": "La ventana de CyreneCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "CyreneCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar CyreneCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de CyreneCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CyreneCode.",
  ...
  "dialog.server.description": "Cambiar el servidor de CyreneCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando CyreneCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando CyreneCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza CyreneCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala CyreneCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que CyreneCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir CyreneCode.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de CyreneCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de CyreneCode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: CyreneCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CyreneCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CyreneCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve CyreneCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CyreneCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CyreneCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CyreneCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CyreneCode.",
