export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de NekoCode",
  ...
  "desktop.menu.ariaLabel": "Menú de NekoCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar NekoCode",
  "desktop.recovery.terminated": "La ventana de NekoCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "NekoCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar NekoCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de NekoCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.addModel.title": "Añadir modelo",
  "dialog.addModel.placeholder": "Selecciona un proveedor para configurar modelos",
  "dialog.addModel.provider.label": "Proveedor",
  "dialog.addModel.provider.placeholder": "Selecciona un proveedor",
  "dialog.addModel.provider.connected": "Conectado",
  "dialog.addModel.provider.group.available": "Proveedores disponibles",
  "dialog.addModel.connected.description": "Este proveedor ya está conectado. Alterna qué modelos aparecen en el selector de modelos.",
  "dialog.addModel.custom.append.description": "Añade nuevos modelos a este proveedor personalizado. Se conserva la configuración existente.",
  "dialog.addModel.custom.append.success.title": "Modelos añadidos",
  "dialog.addModel.custom.append.success.description": "Modelos añadidos a {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NekoCode.",
  ...
  "dialog.server.description": "Cambiar el servidor de NekoCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando NekoCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando NekoCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza NekoCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala NekoCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que NekoCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NekoCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de NekoCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de NekoCode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: NekoCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.tab.pet": "Mascota de escritorio",
  "settings.pet.row.enabled.title": "Mostrar mascota de escritorio",
  "settings.pet.row.enabled.description": "Muestra una mascota acompañante en una ventana siempre visible en tu escritorio",
  "settings.pet.row.character.title": "Personaje",
  "settings.pet.row.character.description": "Elige qué mascota mostrar",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integración con WSL",
  "settings.desktop.wsl.description": "Ejecutar el servidor NekoCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para NekoCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve NekoCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si NekoCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de NekoCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NekoCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de NekoCode.",
