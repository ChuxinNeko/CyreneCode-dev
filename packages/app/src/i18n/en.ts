...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CyreneCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CyreneCode.",
  ...
  "dialog.server.description": "Switch which CyreneCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking CyreneCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating CyreneCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update CyreneCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install CyreneCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CyreneCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CyreneCode.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of CyreneCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CyreneCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CyreneCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the CyreneCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CyreneCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CyreneCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CyreneCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CyreneCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CyreneCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CyreneCode.",
