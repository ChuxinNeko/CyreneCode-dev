...
export const dict = {
  ...
  "dialog.addModel.title": "Add model",
  "dialog.addModel.placeholder": "Select a provider to configure models",
  "dialog.addModel.provider.label": "Provider",
  "dialog.addModel.provider.placeholder": "Select a provider",
  "dialog.addModel.provider.connected": "Connected",
  "dialog.addModel.provider.group.available": "Available providers",
  "dialog.addModel.connected.description":
    "This provider is already connected. Toggle which models appear in the model selector.",
  "dialog.addModel.custom.append.description":
    "Add new models to this custom provider. Existing configuration is preserved.",
  "dialog.addModel.custom.append.success.title": "Models added",
  "dialog.addModel.custom.append.success.description": "Added models to {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Free models provided by NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in NekoCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in NekoCode.",
  ...
  "provider.custom.route.label": "API route",
  "provider.custom.route.chat": "Chat Completions",
  "provider.custom.route.responses": "Responses",
  ...
  "dialog.server.description": "Switch which NekoCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking NekoCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating NekoCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update NekoCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install NekoCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before NekoCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "NekoCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of NekoCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the NekoCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, NekoCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode includes free models so you can start immediately.",
  ...
  "settings.pet.row.enabled.title": "Show desktop pet",
  "settings.pet.row.enabled.description": "Display a pet companion in an always-on-top window on your desktop",
  "settings.pet.row.character.title": "Character",
  "settings.pet.row.character.description": "Choose which pet character to show",
  "settings.backToMain": "Back to main window",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the NekoCode server inside WSL on Windows.",

  "settings.general.section.appearance": "Appearance",
  "settings.appearance.row.windowMaterial.title": "Window material",
  "settings.appearance.row.windowMaterial.description": "Choose the window's background material",
  "settings.windowMaterial.default": "Default",
  ...
  "settings.general.row.language.description": "Change the display language for NekoCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how NekoCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether NekoCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how NekoCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when NekoCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of NekoCode.",
