...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "NekoCode 加载失败",
  "desktop.recovery.terminated": "NekoCode 窗口意外终止",
  "desktop.recovery.unresponsive": "NekoCode 未响应",
  ...
  "desktop.wsl.error.installOpencode": "NekoCode 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 NekoCode",
  "desktop.wsl.error.updateVersion":
    "NekoCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.addProviderAndModel": "添加提供商和模型",
  "dialog.model.manage.description": "自定义模型选择器中显示的模型。",
  "dialog.model.manage.provider.toggle": "切换所有 {{provider}} 模型",

  "dialog.addModel.title": "添加模型",
  "dialog.addModel.placeholder": "选择要配置模型的提供商",
  "dialog.addModel.provider.label": "提供商",
  "dialog.addModel.provider.placeholder": "选择提供商",
  "dialog.addModel.provider.connected": "已连接",
  "dialog.addModel.provider.group.available": "可用的提供商",
  "dialog.addModel.connected.description": "该提供商已连接。切换模型在模型选择器中的显示状态。",
  "dialog.addModel.custom.append.description": "向此自定义提供商添加新模型。保留现有配置。",
  "dialog.addModel.custom.append.success.title": "已添加模型",
  "dialog.addModel.custom.append.success.description": "已向 {{provider}} 添加模型",

  "dialog.model.unpaid.freeModels.title": "NekoCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 NekoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "NekoCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 NekoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 NekoCode 中使用 {{provider}} 模型。",
  ...
  "provider.custom.route.label": "API 路由",
  ...
  "provider.custom.models.context.description": "最大上下文窗口（token 数）",
  "provider.custom.models.context.invalid": "请输入正整数",
  "provider.custom.models.remove": "移除模型",
  "provider.custom.models.add": "添加模型",
  "provider.custom.models.fetch": "从 Base URL 拉取模型",
  "provider.custom.models.fetch.failed": "拉取模型失败",
  "provider.custom.models.fetch.empty": "该提供商未返回任何模型",
  "provider.custom.models.fetch.baseURLRequired": "请先填写 Base URL",
  ...
  "dialog.server.description": "切换此应用连接的 NekoCode 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 NekoCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 NekoCode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 NekoCode。",
  "wsl.onboarding.updateOpencode": "更新 NekoCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 NekoCode 已就绪。",
  "wsl.onboarding.opencodeReady": "NekoCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 NekoCode。",
  "wsl.onboarding.installOpencode": "安装 NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 NekoCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "NekoCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "NekoCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 NekoCode。",
  ...
  "help.tabs.introduction": "NekoCode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NekoCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 NekoCode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：NekoCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "NekoCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.tab.pet": "桌宠",
  "settings.pet.row.enabled.title": "显示桌宠",
  "settings.pet.row.enabled.description": "在桌面上方的置顶窗口中显示宠物伙伴",
  "settings.pet.row.character.title": "角色",
  "settings.pet.row.character.description": "选择要显示的桌宠角色",
  "settings.backToMain": "返回主窗口",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 集成",
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 NekoCode 服务器。",

  "settings.general.section.appearance": "外观",
  "settings.appearance.row.windowMaterial.title": "窗口材质",
  "settings.appearance.row.windowMaterial.description": "选择窗口的背景材质",
  "settings.windowMaterial.default": "默认",
  ...
  "settings.general.row.language.description": "更改 NekoCode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 NekoCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 NekoCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 NekoCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 NekoCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 NekoCode。",
