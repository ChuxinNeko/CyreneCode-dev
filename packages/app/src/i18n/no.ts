...
export const dict = {
  ...
  "desktop.menu.documentation": "NekoCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "NekoCode-meny",
  ...
  "desktop.recovery.loadFailed": "NekoCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "NekoCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "NekoCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av NekoCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av NekoCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.addModel.title": "Legg til modell",
  "dialog.addModel.placeholder": "Velg en leverandør for å konfigurere modeller",
  "dialog.addModel.provider.label": "Leverandør",
  "dialog.addModel.provider.placeholder": "Velg en leverandør",
  "dialog.addModel.provider.connected": "Tilkoblet",
  "dialog.addModel.provider.group.available": "Tilgjengelige leverandører",
  "dialog.addModel.connected.description": "Denne leverandøren er allerede tilkoblet. Veksle hvilke modeller som vises i modellvelgeren.",
  "dialog.addModel.custom.append.description": "Legg til nye modeller til denne tilpassede leverandøren. Eksisterende konfigurasjon bevares.",
  "dialog.addModel.custom.append.success.title": "Modeller lagt til",
  "dialog.addModel.custom.append.success.description": "La til modeller for {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NekoCode.",
  ...
  "dialog.server.description": "Bytt hvilken NekoCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NekoCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til NekoCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NekoCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.tab.pet": "Skrivebordskjæledyr",
  "settings.pet.row.enabled.title": "Vis skrivebordskjæledyr",
  "settings.pet.row.enabled.description": "Viser et kjæledyr i et vindu som alltid er øverst på skrivebordet",
  "settings.pet.row.character.title": "Karakter",
  "settings.pet.row.character.description": "Velg hvilket kjæledyr som skal vises",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-integrasjon",
  "settings.desktop.wsl.description": "Kjør NekoCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NekoCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NekoCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om NekoCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i NekoCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NekoCode starter",
  ...
  "settings.updates.toast.latest.title": "NekoCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av NekoCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker NekoCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer NekoCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater NekoCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer NekoCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før NekoCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "NekoCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter NekoCode på nytt.",
  ...
  "help.tabs.introduction": "NekoCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
