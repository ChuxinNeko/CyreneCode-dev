...
export const dict = {
  ...
  "desktop.menu.documentation": "CyreneCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "CyreneCode-meny",
  ...
  "desktop.recovery.loadFailed": "CyreneCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "CyreneCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "CyreneCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av CyreneCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av CyreneCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CyreneCode.",
  ...
  "dialog.server.description": "Bytt hvilken CyreneCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CyreneCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CyreneCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CyreneCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CyreneCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CyreneCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CyreneCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om CyreneCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i CyreneCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CyreneCode starter",
  ...
  "settings.updates.toast.latest.title": "CyreneCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CyreneCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker CyreneCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer CyreneCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater CyreneCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer CyreneCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før CyreneCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter CyreneCode på nytt.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
