...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "NekoCode 載入失敗",
  "desktop.recovery.terminated": "NekoCode 視窗意外終止",
  "desktop.recovery.unresponsive": "NekoCode 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "NekoCode 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 NekoCode",
  "desktop.wsl.error.updateVersion":
    "NekoCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.addModel.title": "新增模型",
  "dialog.addModel.placeholder": "選擇要設定模型的供應商",
  "dialog.addModel.provider.label": "供應商",
  "dialog.addModel.provider.placeholder": "選擇供應商",
  "dialog.addModel.provider.connected": "已連接",
  "dialog.addModel.provider.group.available": "可用的供應商",
  "dialog.addModel.connected.description": "此供應商已連接。切換模型在模型選擇器中的顯示狀態。",
  "dialog.addModel.custom.append.description": "向此自訂供應商新增模型。保留現有設定。",
  "dialog.addModel.custom.append.success.title": "已新增模型",
  "dialog.addModel.custom.append.success.description": "已向 {{provider}} 新增模型",

  "dialog.model.unpaid.freeModels.title": "NekoCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 NekoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "NekoCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 NekoCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 NekoCode 中使用 {{provider}} 模型。",
  ...
  "provider.custom.models.context.description": "最大上下文視窗（token 數）",
  "provider.custom.models.context.invalid": "請輸入正整數",
  ...
  "dialog.server.description": "切換此應用程式連線的 NekoCode 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 NekoCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 NekoCode 已就緒。",
  "wsl.onboarding.opencodeReady": "NekoCode 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 NekoCode。",
  "wsl.onboarding.installOpencode": "安裝 NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 NekoCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "NekoCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 NekoCode。",
  ...
  "help.tabs.introduction": "NekoCode Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NekoCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 NekoCode 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：NekoCode 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "NekoCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.tab.pet": "桌寵",
  "settings.pet.row.enabled.title": "顯示桌寵",
  "settings.pet.row.enabled.description": "在桌面上方的置頂視窗中顯示寵物夥伴",
  "settings.pet.row.character.title": "角色",
  "settings.pet.row.character.description": "選擇要顯示的桌寵角色",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 整合",
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 NekoCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 NekoCode 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 NekoCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 NekoCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 NekoCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 NekoCode 啟動時自動檢查更新",
  ...
  "settings.router.title": "智慧路由",
  "settings.router.description":
    "智能模型路由會根據每輪請求在 S/M/L/XL 檔位中選擇模型。關閉時，每個工作階段直接使用其選定模型。",
  "settings.router.enable.title": "啟用路由",
  "settings.router.enable.description": "根據請求為每輪路由到對應模型檔位。關閉保持單模型行為。",
  "settings.router.mode.title": "模式",
  "settings.router.mode.description": "observe 僅記錄本應路由到的檔位並保持你的模型；full 套用路由選擇的模型。",
  "settings.router.mode.observe": "觀察（僅記錄）",
  "settings.router.mode.full": "完整（套用路由）",
  "settings.router.tier.title": "檔位",
  "settings.router.tier.description": "每個檔位的 “provider/model”。留空自動回退（S = 便宜模型，M = 你的預設模型）。",
  "settings.router.budget.title": "預算",
  "settings.router.budget.limit.description": "可選的每工作階段美元上限。達到後路由會告警或強制降到便宜檔。",
  "settings.router.budget.action.description": "warn：繼續路由但記錄超支。cap：強制使用便宜檔。",
  "settings.router.budget.action.warn": "告警",
  "settings.router.budget.action.cap": "降至便宜檔",

  "model.router.label": "智慧路由",
  "model.router.selecting": "智慧路由選擇中…",
