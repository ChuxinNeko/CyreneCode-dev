export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in CyreneCode.",
  ...
  "dialog.server.description": "Cambia il server CyreneCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo CyreneCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento CyreneCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna CyreneCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa CyreneCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che CyreneCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri CyreneCode.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di CyreneCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team CyreneCode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: CyreneCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server CyreneCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per CyreneCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di CyreneCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se CyreneCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di CyreneCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di CyreneCode",
  ...
  "settings.updates.toast.latest.title": "CyreneCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di CyreneCode.",
  ...
  "desktop.menu.documentation": "Documentazione di CyreneCode",
  ...
  "desktop.menu.ariaLabel": "Menu CyreneCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare CyreneCode",
  "desktop.recovery.terminated": "La finestra di CyreneCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "CyreneCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di CyreneCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di CyreneCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
