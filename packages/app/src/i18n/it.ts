export const dict = {
  ...
  "dialog.addModel.title": "Aggiungi modello",
  "dialog.addModel.placeholder": "Seleziona un provider per configurare i modelli",
  "dialog.addModel.provider.label": "Provider",
  "dialog.addModel.provider.placeholder": "Seleziona un provider",
  "dialog.addModel.provider.connected": "Connesso",
  "dialog.addModel.provider.group.available": "Provider disponibili",
  "dialog.addModel.connected.description": "Questo provider è già connesso. Attiva o disattiva quali modelli appaiono nel selettore del modello.",
  "dialog.addModel.custom.append.description": "Aggiungi nuovi modelli a questo provider personalizzato. La configurazione esistente viene conservata.",
  "dialog.addModel.custom.append.success.title": "Modelli aggiunti",
  "dialog.addModel.custom.append.success.description": "Modelli aggiunti a {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in NekoCode.",
  ...
  "dialog.server.description": "Cambia il server NekoCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo NekoCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento NekoCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna NekoCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa NekoCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che NekoCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "NekoCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di NekoCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team NekoCode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: NekoCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.tab.pet": "Animale da scrivania",
  "settings.pet.row.enabled.title": "Mostra animale da scrivania",
  "settings.pet.row.enabled.description": "Mostra un animaletto compagno in una finestra sempre in primo piano sul desktop",
  "settings.pet.row.character.title": "Personaggio",
  "settings.pet.row.character.description": "Scegli quale personaggio mostrare",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integrazione WSL",
  "settings.desktop.wsl.description": "Esegui il server NekoCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per NekoCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di NekoCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se NekoCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di NekoCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di NekoCode",
  ...
  "settings.updates.toast.latest.title": "NekoCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di NekoCode.",
  ...
  "desktop.menu.documentation": "Documentazione di NekoCode",
  ...
  "desktop.menu.ariaLabel": "Menu NekoCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare NekoCode",
  "desktop.recovery.terminated": "La finestra di NekoCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "NekoCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di NekoCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di NekoCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
