export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi NekoCode",
  ...
  "desktop.recovery.loadFailed": "NekoCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela NekoCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "NekoCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi NekoCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan NekoCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.addModel.title": "Tambah model",
  "dialog.addModel.placeholder": "Pilih penyedia untuk mengonfigurasi model",
  "dialog.addModel.provider.label": "Penyedia",
  "dialog.addModel.provider.placeholder": "Pilih penyedia",
  "dialog.addModel.provider.connected": "Terhubung",
  "dialog.addModel.provider.group.available": "Penyedia yang tersedia",
  "dialog.addModel.connected.description": "Penyedia ini sudah terhubung. Alihkan model mana yang muncul di pemilih model.",
  "dialog.addModel.custom.append.description": "Tambahkan model baru ke penyedia kustom ini. Konfigurasi yang ada dipertahankan.",
  "dialog.addModel.custom.append.success.title": "Model ditambahkan",
  "dialog.addModel.custom.append.success.description": "Model ditambahkan ke {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di NekoCode.",
  ...
  "dialog.server.description": "Ganti server NekoCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa NekoCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui NekoCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui NekoCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal NekoCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NekoCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NekoCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru NekoCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim NekoCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: NekoCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.tab.pet": "Hewan peliharaan desktop",
  "settings.pet.row.enabled.title": "Tampilkan hewan peliharaan desktop",
  "settings.pet.row.enabled.description": "Menampilkan hewan peliharaan di jendela yang selalu di atas desktop Anda",
  "settings.pet.row.character.title": "Karakter",
  "settings.pet.row.character.description": "Pilih karakter hewan peliharaan yang ingin ditampilkan",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integrasi WSL",
  "settings.desktop.wsl.description": "Jalankan server NekoCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk NekoCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan NekoCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah NekoCode mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema NekoCode.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat NekoCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru NekoCode.",
