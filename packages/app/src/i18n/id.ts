export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi CyreneCode",
  ...
  "desktop.recovery.loadFailed": "CyreneCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela CyreneCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "CyreneCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi CyreneCode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan CyreneCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di CyreneCode.",
  ...
  "dialog.server.description": "Ganti server CyreneCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa CyreneCode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui CyreneCode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui CyreneCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal CyreneCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CyreneCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali CyreneCode.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru CyreneCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim CyreneCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: CyreneCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server CyreneCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk CyreneCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan CyreneCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah CyreneCode mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema CyreneCode.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat CyreneCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru CyreneCode.",
