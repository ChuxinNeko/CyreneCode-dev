export const dict = {
  ...
  "desktop.menu.documentation": "NekoCode दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "NekoCode मेन्यू",
  ...
  "desktop.recovery.loadFailed": "NekoCode लोड नहीं हो सका",
  "desktop.recovery.terminated": "NekoCode विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "NekoCode प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "NekoCode इंस्टॉल नहीं हो सका",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में NekoCode इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "NekoCode अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.addModel.title": "मॉडल जोड़ें",
  "dialog.addModel.placeholder": "मॉडल कॉन्फ़िगर करने के लिए प्रोवाइडर चुनें",
  "dialog.addModel.provider.label": "प्रोवाइडर",
  "dialog.addModel.provider.placeholder": "प्रोवाइडर चुनें",
  "dialog.addModel.provider.connected": "जुड़ा हुआ",
  "dialog.addModel.provider.group.available": "उपलब्ध प्रोवाइडर",
  "dialog.addModel.connected.description": "यह प्रोवाइडर पहले से जुड़ा हुआ है। टॉगल करें कि मॉडल चयनकर्ता में कौन-से मॉडल दिखाई दें।",
  "dialog.addModel.custom.append.description": "इस कस्टम प्रोवाइडर में नए मॉडल जोड़ें। मौजूदा कॉन्फ़िगरेशन सुरक्षित रखा जाता है।",
  "dialog.addModel.custom.append.success.title": "मॉडल जोड़े गए",
  "dialog.addModel.custom.append.success.description": "{{provider}} में मॉडल जोड़े गए",

  "dialog.model.unpaid.freeModels.title": "NekoCode द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और NekoCode में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और NekoCode में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा NekoCode में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस NekoCode सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "NekoCode की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में NekoCode की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "NekoCode अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में NekoCode अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में NekoCode को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "NekoCode को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "NekoCode {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "NekoCode तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में NekoCode स्थापित करें।",
  "wsl.onboarding.installOpencode": "NekoCode स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NekoCode द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "NekoCode इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर NekoCode को फिर से खोलें।",
  ...
  "help.tabs.introduction": "NekoCode Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NekoCode ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट NekoCode टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, NekoCode अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "NekoCode में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.tab.pet": "डेस्कटॉप पालतू",
  "settings.pet.row.enabled.title": "डेस्कटॉप पालतू दिखाएँ",
  "settings.pet.row.enabled.description": "आपके डेस्कटॉप पर हमेशा ऊपर रहने वाली विंडो में एक पालतू साथी दिखाता है",
  "settings.pet.row.character.title": "चरित्र",
  "settings.pet.row.character.description": "चुनें कि कौन सा पालतू चरित्र दिखाना है",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL एकीकरण",
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर NekoCode सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "NekoCode के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि NekoCode आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि NekoCode सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि NekoCode की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "NekoCode लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप NekoCode का नवीनतम संस्करण चला रहे हैं।",
