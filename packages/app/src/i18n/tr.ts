...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CyreneCode yüklenemedi",
  "desktop.recovery.terminated": "CyreneCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "CyreneCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "CyreneCode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "CyreneCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CyreneCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CyreneCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak CyreneCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CyreneCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CyreneCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "CyreneCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde CyreneCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "CyreneCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde CyreneCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki CyreneCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "CyreneCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde CyreneCode hazır.",
  "wsl.onboarding.opencodeReady": "CyreneCode hazır.",
  "wsl.onboarding.installOpencodeIn": "CyreneCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "CyreneCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CyreneCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından CyreneCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CyreneCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CyreneCode ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: CyreneCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CyreneCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "CyreneCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CyreneCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "CyreneCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CyreneCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CyreneCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CyreneCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CyreneCode'un en son sürümünü kullanıyorsunuz.",
