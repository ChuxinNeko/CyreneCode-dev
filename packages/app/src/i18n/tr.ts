...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "NekoCode yüklenemedi",
  "desktop.recovery.terminated": "NekoCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "NekoCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "NekoCode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "NekoCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.addModel.title": "Model ekle",
  "dialog.addModel.placeholder": "Modelleri yapılandırmak için bir sağlayıcı seçin",
  "dialog.addModel.provider.label": "Sağlayıcı",
  "dialog.addModel.provider.placeholder": "Bir sağlayıcı seçin",
  "dialog.addModel.provider.connected": "Bağlı",
  "dialog.addModel.provider.group.available": "Kullanılabilir sağlayıcılar",
  "dialog.addModel.connected.description": "Bu sağlayıcı zaten bağlı. Model seçicide hangi modellerin görüneceğini açın/kapatın.",
  "dialog.addModel.custom.append.description": "Bu özel sağlayıcıya yeni modeller ekleyin. Mevcut yapılandırma korunur.",
  "dialog.addModel.custom.append.success.title": "Modeller eklendi",
  "dialog.addModel.custom.append.success.description": "{{provider}} için modeller eklendi",

  "dialog.model.unpaid.freeModels.title": "NekoCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve NekoCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak NekoCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak NekoCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi NekoCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "NekoCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde NekoCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "NekoCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde NekoCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki NekoCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "NekoCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde NekoCode hazır.",
  "wsl.onboarding.opencodeReady": "NekoCode hazır.",
  "wsl.onboarding.installOpencodeIn": "NekoCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "NekoCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NekoCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "NekoCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından NekoCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "NekoCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NekoCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı NekoCode ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: NekoCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "NekoCode Masaüstü",
  ...
  "settings.tab.pet": "Masaüstü evcil hayvan",
  "settings.pet.row.enabled.title": "Masaüstü evcil hayvanı göster",
  "settings.pet.row.enabled.description": "Masaüstünüzde her zaman üstte olan bir pencerede evcil hayvan gösterir",
  "settings.pet.row.character.title": "Karakter",
  "settings.pet.row.character.description": "Hangi evcil hayvan karakterinin gösterileceğini seçin",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL entegrasyonu",
  "settings.desktop.wsl.description": "NekoCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "NekoCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "NekoCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "NekoCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "NekoCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "NekoCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "NekoCode'un en son sürümünü kullanıyorsunuz.",
