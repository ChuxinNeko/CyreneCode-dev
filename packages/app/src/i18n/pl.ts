export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja CyreneCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać CyreneCode",
  "desktop.recovery.terminated": "Okno CyreneCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "CyreneCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować CyreneCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja CyreneCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CyreneCode.",
  ...
  "dialog.server.description": "Przełącz serwer CyreneCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie CyreneCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie CyreneCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj CyreneCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj CyreneCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim CyreneCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz CyreneCode.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja CyreneCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CyreneCode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: CyreneCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "CyreneCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer CyreneCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CyreneCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd CyreneCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CyreneCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CyreneCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CyreneCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CyreneCode.",
