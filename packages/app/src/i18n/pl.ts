export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja NekoCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać NekoCode",
  "desktop.recovery.terminated": "Okno NekoCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "NekoCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować NekoCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja NekoCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.addModel.title": "Dodaj model",
  "dialog.addModel.placeholder": "Wybierz dostawcę, aby skonfigurować modele",
  "dialog.addModel.provider.label": "Dostawca",
  "dialog.addModel.provider.placeholder": "Wybierz dostawcę",
  "dialog.addModel.provider.connected": "Połączony",
  "dialog.addModel.provider.group.available": "Dostępni dostawcy",
  "dialog.addModel.connected.description": "Ten dostawca jest już połączony. Przełącz, które modele pojawiają się w wyborze modelu.",
  "dialog.addModel.custom.append.description": "Dodaj nowe modele do tego niestandardowego dostawcy. Istniejąca konfiguracja zostaje zachowana.",
  "dialog.addModel.custom.append.success.title": "Dodano modele",
  "dialog.addModel.custom.append.success.description": "Dodano modele do {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NekoCode.",
  ...
  "dialog.server.description": "Przełącz serwer NekoCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie NekoCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie NekoCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj NekoCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj NekoCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim NekoCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "NekoCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja NekoCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NekoCode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: NekoCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "NekoCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.tab.pet": "Zwierzak pulpitu",
  "settings.pet.row.enabled.title": "Pokazuj zwierzaka pulpitu",
  "settings.pet.row.enabled.description": "Wyświetla zwierzaka-towarzysza w oknie zawsze na wierzchu na pulpicie",
  "settings.pet.row.character.title": "Postać",
  "settings.pet.row.character.description": "Wybierz, którą postać pokazać",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integracja z WSL",
  "settings.desktop.wsl.description": "Uruchamiaj serwer NekoCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NekoCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd NekoCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NekoCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NekoCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NekoCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NekoCode.",
