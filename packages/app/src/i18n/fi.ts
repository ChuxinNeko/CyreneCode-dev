export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "CyreneCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CyreneCodessa.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja CyreneCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CyreneCodessa.",
  ...
  "dialog.server.description": "Vaihda CyreneCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan CyreneCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan CyreneCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään CyreneCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään CyreneCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä CyreneCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna CyreneCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin CyreneCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten CyreneCode uudelleen.",
  ...
  "toast.update.description": "CyreneCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä CyreneCode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että CyreneCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita CyreneCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda CyreneCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä CyreneCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö CyreneCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta CyreneCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun CyreneCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät CyreneCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "CyreneCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "CyreneCode-valikko",
  ...
  "desktop.recovery.loadFailed": "CyreneCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "CyreneCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "CyreneCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "CyreneCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CyreneCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "CyreneCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
