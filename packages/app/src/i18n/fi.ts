export const dict = {
  ...
  "dialog.addModel.title": "Lisää malli",
  "dialog.addModel.placeholder": "Valitse palveluntarjoaja määrittääksesi malleja",
  "dialog.addModel.provider.label": "Palveluntarjoaja",
  "dialog.addModel.provider.placeholder": "Valitse palveluntarjoaja",
  "dialog.addModel.provider.connected": "Yhdistetty",
  "dialog.addModel.provider.group.available": "Saatavilla olevat palveluntarjoajat",
  "dialog.addModel.connected.description": "Tämä palveluntarjoaja on jo yhdistetty. Ota käyttöön tai poista käytöstä mallit, jotka näkyvät mallivalitsimessa.",
  "dialog.addModel.custom.append.description": "Lisää uusia malleja tähän mukautettuun palveluntarjoajaan. Nykyinen määritys säilytetään.",
  "dialog.addModel.custom.append.success.title": "Mallit lisätty",
  "dialog.addModel.custom.append.success.description": "Lisätty malleja {{provider}}",

  "dialog.model.unpaid.freeModels.title": "NekoCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NekoCodessa.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja NekoCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NekoCodessa.",
  ...
  "dialog.server.description": "Vaihda NekoCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan NekoCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan NekoCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään NekoCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään NekoCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä NekoCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna NekoCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin NekoCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "NekoCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten NekoCode uudelleen.",
  ...
  "toast.update.description": "NekoCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä NekoCode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että NekoCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.tab.pet": "Työpöytälemmikki",
  "settings.pet.row.enabled.title": "Näytä työpöytälemmikki",
  "settings.pet.row.enabled.description": "Näyttää lemmikkikumppanin aina päällimmäisessä ikkunassa työpöydälläsi",
  "settings.pet.row.character.title": "Hahmo",
  "settings.pet.row.character.description": "Valitse, mikä lemmikki näytetään",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-integraatio",
  "settings.desktop.wsl.description": "Suorita NekoCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda NekoCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä NekoCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö NekoCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta NekoCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun NekoCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät NekoCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "NekoCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "NekoCode-valikko",
  ...
  "desktop.recovery.loadFailed": "NekoCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "NekoCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "NekoCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "NekoCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NekoCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "NekoCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
