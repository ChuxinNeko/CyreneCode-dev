export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za NekoCode",
  ...
  "desktop.menu.ariaLabel": "NekoCode meni",
  ...
  "desktop.recovery.loadFailed": "NekoCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor NekoCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "NekoCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija NekoCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje NekoCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.addModel.placeholder": "Odaberite provajdera za konfiguraciju modela",
  "dialog.addModel.provider.label": "Provajder",
  "dialog.addModel.provider.placeholder": "Odaberite provajdera",
  "dialog.addModel.provider.connected": "Povezano",
  "dialog.addModel.provider.group.available": "Dostupni provajderi",
  "dialog.addModel.connected.description": "Ovaj provajder je već povezan. Uključite/isključite koje se modeli prikazuju u izborniku modela.",
  "dialog.addModel.custom.append.description": "Dodajte nove modele ovom prilagođenom provajderu. Postojeća konfiguracija je sačuvana.",
  "dialog.addModel.custom.append.success.title": "Modeli dodani",
  "dialog.addModel.custom.append.success.description": "Dodani modeli za {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u NekoCode-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u NekoCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u NekoCode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se NekoCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera NekoCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje NekoCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj NekoCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj NekoCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi NekoCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "NekoCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori NekoCode.",
  ...
  "help.tabs.introduction": "NekoCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NekoCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku NekoCode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: NekoCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.tab.pet": "Ljubimac na radnoj površini",
  "settings.pet.row.enabled.title": "Prikaži ljubimca na radnoj površini",
  "settings.pet.row.enabled.description": "Prikazuje ljubimca u prozoru koji je uvijek na vrhu radne površine",
  "settings.pet.row.character.title": "Lik",
  "settings.pet.row.character.description": "Odaberite kojeg ljubimca prikazati",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integracija",
  "settings.desktop.wsl.description": "Pokreni NekoCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u NekoCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako NekoCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li NekoCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu NekoCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se NekoCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju NekoCode-a.",
