export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za CyreneCode",
  ...
  "desktop.menu.ariaLabel": "CyreneCode meni",
  ...
  "desktop.recovery.loadFailed": "CyreneCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor CyreneCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "CyreneCode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija CyreneCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje CyreneCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CyreneCode-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CyreneCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CyreneCode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se CyreneCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera CyreneCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje CyreneCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj CyreneCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj CyreneCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi CyreneCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori CyreneCode.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija CyreneCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CyreneCode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CyreneCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CyreneCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CyreneCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako CyreneCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CyreneCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CyreneCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CyreneCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CyreneCode-a.",
