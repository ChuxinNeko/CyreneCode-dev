export const dict = {
  ...
  "desktop.recovery.loadFailed": "NekoCode kunde inte läsas in",
  "desktop.recovery.terminated": "NekoCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "NekoCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av NekoCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NekoCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.addModel.title": "Lägg till modell",
  "dialog.addModel.placeholder": "Välj en leverantör för att konfigurera modeller",
  "dialog.addModel.provider.label": "Leverantör",
  "dialog.addModel.provider.placeholder": "Välj en leverantör",
  "dialog.addModel.provider.connected": "Ansluten",
  "dialog.addModel.provider.group.available": "Tillgängliga leverantörer",
  "dialog.addModel.connected.description": "Den här leverantören är redan ansluten. Växla vilka modeller som visas i modellväljaren.",
  "dialog.addModel.custom.append.description": "Lägg till nya modeller till den här anpassade leverantören. Befintlig konfiguration bevaras.",
  "dialog.addModel.custom.append.success.title": "Modeller tillagda",
  "dialog.addModel.custom.append.success.description": "Modeller tillagda för {{provider}}",

  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i NekoCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i NekoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i NekoCode.",
  ...
  "dialog.server.description": "Växla vilken NekoCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar NekoCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar NekoCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar NekoCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar NekoCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera NekoCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera NekoCode",
  "wsl.onboarding.opencodeReadyIn": "NekoCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "NekoCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera NekoCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera NekoCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan NekoCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "NekoCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan NekoCode igen.",
  ...
  "help.tabs.introduction": "NekoCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av NekoCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till NekoCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, NekoCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "NekoCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.tab.pet": "Skrivbordsdjur",
  "settings.pet.row.enabled.title": "Visa skrivbordsdjur",
  "settings.pet.row.enabled.description": "Visar ett husdjur i ett fönster som alltid ligger överst på skrivbordet",
  "settings.pet.row.character.title": "Karaktär",
  "settings.pet.row.character.description": "Välj vilket husdjur som ska visas",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-integration",
  "settings.desktop.wsl.description": "Kör NekoCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för NekoCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur NekoCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om NekoCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa NekoCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när NekoCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av NekoCode.",
