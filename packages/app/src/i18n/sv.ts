export const dict = {
  ...
  "desktop.recovery.loadFailed": "CyreneCode kunde inte läsas in",
  "desktop.recovery.terminated": "CyreneCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "CyreneCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av CyreneCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CyreneCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i CyreneCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i CyreneCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i CyreneCode.",
  ...
  "dialog.server.description": "Växla vilken CyreneCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar CyreneCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar CyreneCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar CyreneCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar CyreneCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera CyreneCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera CyreneCode",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "CyreneCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera CyreneCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera CyreneCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan CyreneCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan CyreneCode igen.",
  ...
  "help.tabs.introduction": "CyreneCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av CyreneCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till CyreneCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, CyreneCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "CyreneCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör CyreneCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för CyreneCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur CyreneCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om CyreneCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa CyreneCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när CyreneCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av CyreneCode.",
