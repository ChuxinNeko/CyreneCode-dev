...
export const dict = {
  ...
  "dialog.addModel.title": "Modell hinzufügen",
  "dialog.addModel.placeholder": "Anbieter zum Konfigurieren von Modellen auswählen",
  "dialog.addModel.provider.label": "Anbieter",
  "dialog.addModel.provider.placeholder": "Anbieter auswählen",
  "dialog.addModel.provider.connected": "Verbunden",
  "dialog.addModel.provider.group.available": "Verfügbare Anbieter",
  "dialog.addModel.connected.description": "Dieser Anbieter ist bereits verbunden. Schalten Sie um, welche Modelle in der Modellauswahl erscheinen.",
  "dialog.addModel.custom.append.description": "Fügen Sie diesem benutzerdefinierten Anbieter neue Modelle hinzu. Die bestehende Konfiguration wird beibehalten.",
  "dialog.addModel.custom.append.success.title": "Modelle hinzugefügt",
  "dialog.addModel.custom.append.success.description": "Modelle zu {{provider}} hinzugefügt",

  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von NekoCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NekoCode zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "NekoCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in NekoCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NekoCode zu nutzen.",
  ...
  "provider.custom.models.context.description": "Maximum context window in tokens",
  "provider.custom.models.context.invalid": "Enter a positive integer",
  ...
  "dialog.server.description": "Wechseln Sie den NekoCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "NekoCode",
  ...
  "wsl.onboarding.checkingOpencode": "NekoCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "NekoCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "NekoCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "NekoCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie NekoCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "NekoCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "NekoCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "NekoCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie NekoCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "NekoCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NekoCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor NekoCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "NekoCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann NekoCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von NekoCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem NekoCode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: NekoCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "NekoCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "NekoCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "NekoCode Desktop",
  "settings.section.desktop": "Desktop",
  "settings.section.server": "Server",
  "settings.tab.general": "Allgemein",
  "settings.tab.shortcuts": "Tastenkombinationen",
  "settings.tab.pet": "Schreibtier",
  "settings.pet.row.enabled.title": "Schreibtier anzeigen",
  "settings.pet.row.enabled.description": "Zeigt einen tierischen Begleiter in einem Immer-im-Vordergrund-Fenster auf deinem Desktop",
  "settings.pet.row.character.title": "Charakter",
  "settings.pet.row.character.description": "Wähle aus, welcher Charakter angezeigt wird",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-Integration",
  "settings.desktop.wsl.description": "NekoCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für NekoCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie NekoCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob NekoCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von NekoCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von NekoCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "NekoCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von NekoCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "NekoCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das NekoCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "NekoCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "NekoCode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "NekoCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das NekoCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "NekoCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
