...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von CyreneCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CyreneCode zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "CyreneCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in CyreneCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CyreneCode zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den CyreneCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "CyreneCode",
  ...
  "wsl.onboarding.checkingOpencode": "CyreneCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "CyreneCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "CyreneCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "CyreneCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie CyreneCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "CyreneCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "CyreneCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "CyreneCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie CyreneCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "CyreneCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CyreneCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor CyreneCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "CyreneCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann CyreneCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von CyreneCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CyreneCode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CyreneCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "CyreneCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "CyreneCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "CyreneCode Desktop",
  ...
  "settings.desktop.wsl.description": "CyreneCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CyreneCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie CyreneCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob CyreneCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CyreneCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CyreneCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "CyreneCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von CyreneCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "CyreneCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das CyreneCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "CyreneCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "CyreneCode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CyreneCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das CyreneCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "CyreneCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
