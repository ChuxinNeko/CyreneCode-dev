export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo NekoCoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "NekoCoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää NekoCoden uudelleen?",
