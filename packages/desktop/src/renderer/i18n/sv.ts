export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av NekoCode har laddats ned. Vill du installera den och starta om programmet?",
