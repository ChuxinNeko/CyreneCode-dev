export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av CyreneCode har laddats ned. Vill du installera den och starta om programmet?",
