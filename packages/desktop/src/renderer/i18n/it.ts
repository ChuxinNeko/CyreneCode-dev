export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di CyreneCode è stata scaricata. Vuoi installarla e riavviare l'app?",
