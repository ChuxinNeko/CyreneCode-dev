export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di NekoCode è stata scaricata. Vuoi installarla e riavviare l'app?",
