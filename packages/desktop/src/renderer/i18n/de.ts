export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von NekoCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
