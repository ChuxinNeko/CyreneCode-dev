export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von CyreneCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
