export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của NekoCode đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
