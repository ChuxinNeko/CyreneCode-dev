export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "CyreneCode versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
