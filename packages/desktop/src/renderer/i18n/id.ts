export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "NekoCode versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
