export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju CyreneCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} CyreneCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
