export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju NekoCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} NekoCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
