export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av NekoCode er lastet ned. Vil du installere den og starte på nytt?",
