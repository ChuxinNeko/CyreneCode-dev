export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av CyreneCode er lastet ned. Vil du installere den og starte på nytt?",
