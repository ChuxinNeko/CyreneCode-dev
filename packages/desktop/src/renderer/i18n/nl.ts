export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van NekoCode is gedownload. Wil je deze installeren en NekoCode opnieuw starten?",
