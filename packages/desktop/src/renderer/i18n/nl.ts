export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van CyreneCode is gedownload. Wil je deze installeren en CyreneCode opnieuw starten?",
