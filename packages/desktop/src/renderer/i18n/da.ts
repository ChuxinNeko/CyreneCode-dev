export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af NekoCode er blevet downloadet. Vil du installere den og genstarte?",
