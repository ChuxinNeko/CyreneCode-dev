export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af CyreneCode er blevet downloadet. Vil du installere den og genstarte?",
