export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} CyreneCode завантажено. Бажаєте встановити її та перезапустити?",
