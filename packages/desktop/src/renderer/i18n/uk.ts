export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} NekoCode завантажено. Бажаєте встановити її та перезапустити?",
