export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji NekoCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} NekoCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
