export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji CyreneCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} CyreneCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
